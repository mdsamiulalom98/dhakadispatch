                ...
                <form action="{{route('banners.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('link') is-invalid @enderror" name="title" value="{{$edit_data->title}}" id="title">
                            @error('title')
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea type="text" class="summernote form-control @error('link') is-invalid @enderror" name="description" id="description">{{$edit_data->description}}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>

        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="{{route('counters.index')}}" class="btn btn-primary waves-effect waves-light btn-sm rounded-pill">Manage</a>
                </div>
                ...
                <form action="{{route('counters.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data" name="editForm">
                    ...
                    <div class="col-sm-12 mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('counter') is-invalid @enderror" name="counter" value="{{ $edit_data->counter }}" id="counter" required="">
                            @error('counter')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>

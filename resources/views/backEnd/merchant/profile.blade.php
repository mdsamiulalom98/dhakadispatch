            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <a href="{{ route('merchants.menual_payment',['id'=>$profile->id]) }}" class="btn btn-success rounded-pill">Manual Payment</a>
                        <a href="{{ route('merchants.index') }}" class="btn btn-primary rounded-pill">Merchant List</a>
                        <form method="post" action="{{ route('merchants.adminlog') }}" class="d-inline" target="_blank">
                            @csrf
                    ...
                    <h4 class="page-title">Merchant Overview</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                            ...
                            <table class="table">
                                <tbody>
                                    <tr class="text-muted mb-2 font-13">
                                        <td>Merchant ID </td>
                                        <td class="ms-2">{{ $profile->shop_id }}</td>
                                    </tr>
                                    <tr class="text-muted mb-2 font-13">
                                        <td>Full Name </td>

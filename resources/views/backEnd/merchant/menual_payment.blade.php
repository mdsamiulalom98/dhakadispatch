...
@section('title', 'Merchant Menual Payment')
@section('css')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title"> <a href="{{route('merchants.profile',['id'=>request()->get('id')])}}"> <i class="fa fa-arrow-left"></i> Back</a> Merchant Menual Payment</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                            ...
                            <table class="table parcel-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>৳ {{$value->cod - ($value->delivery_charge+$value->cod_charge)}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                                <tfoot>
                                    <tr>
                                        ...
                                        <td><strong>৳ {{$parcels->sum('payable_amount')}}</strong></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ route('merchants.menual_payment.paid') }}" method="POST"
                    ...
                    <div class="col-sm-12 mb-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="payment_method" id="payment_method">
                                ...
                                <option value="bank" data-method="{{$merchantpay->account_number ?? ''}}">Bank</option>
                                <option value="bkash" data-method="{{$merchantpay->bkash ?? ''}}">Bkash</option>
                                <option value="nagad" data-method="{{$merchantpay->nagad ?? ''}}">Nagad</option>
                                <option value="rocket" data-method="{{$merchantpay->rocket ?? ''}}">Rocket</option>

            ...
            <div class="col-12">
                <div class="page-title-box">
                     <div class="page-title-right">
                        <a href="{{route('merchants.create')}}" class="btn btn-primary waves-effect waves-light btn-sm rounded-pill">Create</a>
                    </div>
                    <h4 class="page-title">Merchant Manage</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                                            ...
                                            <td>
                                                <div class="button-list">
                                                    @if ($value->status == 'active')
                                                        <form method="post" action="{{ route('merchants.inactive') }}"
                                                            class="d-inline">
                                                            @csrf
                                                    ...
                                                    @else
                                                        <form method="post" action="{{ route('merchants.active') }}"
                                                            class="d-inline">
                                                            @csrf
                                                            <input type="hidden" value="{{ $value->id }}"
                                                                name="hidden_id">
                                                    ...
                                                    <a href="{{ route('merchants.edit', $value->id) }}"
                                                        class="btn btn-xs btn-primary waves-effect waves-light"><i
                                                            class="fe-edit-1"></i></a>

                                                    <a href="{{ route('merchants.profile', ['id' => $value->id]) }}"
                                                        class="btn btn-xs btn-blue waves-effect waves-light"><i
                                                            class="fe-eye"></i></a>

                                                    <form method="post" action="{{ route('merchants.adminlog') }}"

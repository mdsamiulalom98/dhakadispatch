                                ...
                                <tbody>
                                    @foreach ($payments as $key => $value)
                                        <tr>
                                            ...
                                            <td>{{$value->merchant?$value->merchant->name:''}} <br> {{$value->merchant?$value->merchant->phone:''}}<br>{{$value->merchant?$value->merchant->address:''}}</td>
                                            <td>৳ {{$value->cod}}</td>
                                            ...
                                            <td><a href="{{route('merchants.invoice',$value->id)}}" class="btn btn-xs btn-primary waves-effect waves-light"><i class="fe-eye"></i></a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>

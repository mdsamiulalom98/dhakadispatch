        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">Parcel View #{{$parcel->parcel_id}}</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                        ...
                        <div class="col-sm-12">
                            <div class="parcel-btns">
                                <div class="button-list">
                                    <a href="{{route('merchant.parcel.label_print',$parcel->id)}}" class="btn btn-info waves-effect waves-light"><i class="fas fa-print"></i> Label</a>
                                    <a href="{{route('merchant.parcel.edit',$parcel->parcel_id)}}" class="btn btn-pink waves-effect waves-light"><i class="fas fa-pencil"></i> Edit</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">

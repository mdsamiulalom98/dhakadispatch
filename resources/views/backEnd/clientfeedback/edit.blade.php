...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="{{route('clientfeedback.index')}}" class="btn btn-primary waves-effect waves-light btn-sm rounded-pill">Manage</a>
                </div>
                <h4 class="page-title">Client Feedback Edit</h4>
            </div>
        </div>
    </div>       
    <!-- end page title -->
   <div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <form action="{{route('clientfeedback.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data" name="editForm">
                    @csrf
                    ...
                    <div class="col-sm-12 mb-3">
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control @error('company') is-invalid @enderror"
                                name="company" value="{{ old('company') }}" id="company">
                            <img src="{{asset($edit_data->company)}}" class="edit-image" alt="">
                            @error('company')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12 mb-3">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('ratting') is-invalid @enderror"
                                ...
                                <option value="1" {{$edit_data->ratting == 1 ? 'selected' : ''}}>1</option>
                                <option value="2" {{$edit_data->ratting == 2 ? 'selected' : ''}}>2</option>
                                <option value="3" {{$edit_data->ratting == 3 ? 'selected' : ''}}>3</option>
                                <option value="4" {{$edit_data->ratting == 4 ? 'selected' : ''}}>4</option>
                                <option value="5" {{$edit_data->ratting == 5 ? 'selected' : ''}}>5</option>
                            </select>
                            @error('ratting')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="col-sm-12 mb-3">
                        <div class="form-group">
                            ...
                            <textarea name="message" class="summernote form-control @error('message') is-invalid @enderror" id="message"
                                rows="5">{{$edit_data->message}}</textarea>
                            @error('message')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>

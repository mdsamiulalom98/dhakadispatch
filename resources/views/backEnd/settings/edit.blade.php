        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('settings.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="form-group">
                            <label for="about" class="form-label">Footer About *</label>
                            <textarea type="file" class="form-control @error('about') is-invalid @enderror" name="about"  id="about" >{{$edit_data->about}}</textarea>
                            @error('about')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>

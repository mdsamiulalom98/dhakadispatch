...
@section('content')
    ...
    <section class="why-choose-section">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-sm-12">
                    <div class="why-choose-us owl-carousel">
                        @foreach ($whychooseus as $key => $value)
                            @if ($key > 0)
                            <div class="whychoose-us-item">
                                <img src="{{ asset($value->image) }}" alt="">
                                <h3>{{ $value->title }}</h3>
                                <p>{!! $value->description !!} </p>
                            </div>
    ...
    <section class="guest-parcel-section">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-sm-12">
                    <form action="{{ route('guest.parcel.store') }}" method="POST" enctype="multipart/form-data"
                        data-parsley-validate="" class="row">
                        @csrf
                        <div class="col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-sm-4 mb-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text"
                                            ...
                                            placeholder="Type Customer Number" required>
                                        @if ($errors->has('phone'))
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-sm-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 zone cost_calculate" name="zone_id"
                                            id="zone_id">
                                            <option value="">Select..</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 area cost_calculate" name="area"
                                            id="area">
                                            <option value="">Select..</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-4 mb-3">
                                    ...
                                    <div class="form-group">
                                        <input
                                            class="merchant_id form-control {{ $errors->has('merchant_id') ? 'is-invalid' : '' }}"
                                            name="merchant_id" id="merchant_id" value="{{ old('merchant_id') }}"
                                            placeholder="Type Your Merchant ID">
                                ...
                                <div class="col-sm-4 mb-3">
                                    ...
                                    <div class="form-group">
                                        <input type="number"
                                            class="cod cost_calculate form-control {{ $errors->has('cod') ? 'is-invalid' : '' }}"
                                            name="cod" id="cod" value="{{ old('cod') }}"
                                            placeholder="Type COD Amount" required>
                                        @if ($errors->has('cod'))
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-sm-4 mb-3">
                                    ...
                                    <div class="form-group">
                                        <input type="number"
                                            class="weight cost_calculate form-control {{ $errors->has('weight') ? 'is-invalid' : '' }}"
                                            name="weight" id="weight" value="{{ old('weight') }}"
                                            placeholder="Type Parcel Weight" required>
                        ...
                        @foreach ($faqs as $key => $value)
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapse{{ $key }}" class="accordion-collapse collapse"
                                    aria-labelledby="heading{{ $key }}" data-bs-parent="#accordion_faq">

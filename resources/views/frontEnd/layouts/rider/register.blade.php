            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-sm-12">
                    <div class="auth-inner">
                        ...
                        <form action="{{ route('rider.store') }}" method="POST" data-parsley-validate="" autocomplete="off" class="row">
                            @csrf
                            <div class="col-sm-12">
                            ...
                            <!-- form group -->
                            <p class="quick_link">Already have a account? <a href="{{ route('rider.login') }}">
                                    Login</a></p>
                        </form>
                    </div>
                </div>

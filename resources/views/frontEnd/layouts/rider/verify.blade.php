            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-sm-12">
                    <div class="alert alert-danger alert-dismissible">
                        ...
                        <p>Your Verify OTP Is : {{App\Models\Rider::where('phone',Session::get('verify_phone'))->first()->verify}}</p>
                        @endif
                    ...
                    <div class="auth-inner">
                        ...
                        <form action="{{ route('rider.account.verify') }}" method="POST" data-parsley-validate="">
                            @csrf

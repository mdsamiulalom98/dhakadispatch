	    ...
	    <div class="row">
	        ...
	        <div class="col-sm-9">
	            <div class="chart-des">
	                ...
	                <div class="row">
	                    <div class="col-sm-4">  
	                      <a href="{{route('rider.parcel.index','delivered')}}">
	                    ...
	                    <!--end-col-->
	                    <div class="col-sm-4">
	                      <a href="{{route('rider.parcel.index','all')}}">
	                    ...
	                    <!--end-col-->
	                    <div class="col-sm-4">
	                      <a href="{{route('rider.parcel.index','returned')}}">
        	...
        	<div class="col-sm-12">
        		<div class="parcel-counter">
        		    ...
        		    if(request('start_date') && request('end_date')){
        			    $parcel_count = App\Models\Parcel::select('id','rider_id','status','created_at')->where(['merchant_id'=> Auth::guard('rider')->user()->id,'status'=>$value->id])->whereBetween('created_at', [request('start_date'),request('end_date')])->count();
        		    }else{
        		    	$parcel_count = App\Models\Parcel::select('id','rider_id','status','created_at')->where(['merchant_id'=> Auth::guard('rider')->user()->id,'status'=>$value->id])->count();
        		    }
        			@endphp
        			<div class="counter-item">
        			    <a href="{{route('rider.parcel.index',$value->slug)}}">
            				<div class="icon">

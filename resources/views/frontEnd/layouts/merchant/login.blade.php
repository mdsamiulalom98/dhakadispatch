            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-sm-12">
                    <div class="auth-inner">
                        <h5 class="title">Merchant Login</h5>
                        <form action="{{ route('merchant.signin') }}" method="POST" data-parsley-validate="">
                            @csrf
                            ...
                            <div class="form-group mb-3 text-end">
                                <a href="{{ route('merchant.forgot.password') }}">Forgot Password?</a>
                            </div>
                            ...
                            <p class="quick_link">
                                ...
                                <a href="{{ route('merchant.register') }}"> Create Account</a>
                            </p>
                        </form>
                    </div>
                </div>

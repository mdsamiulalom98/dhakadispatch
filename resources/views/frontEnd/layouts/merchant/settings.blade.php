				...
				<div class="user-settings">
                    ...
                    <div class="row">
                        ...
                        <div class="tab-content" id="myTabContent">
                          ...
                          <form action="{{ route('merchant.basic_update') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 district" name="district" id="district" required>
                                                <option value="">Select..</option>
                                                @foreach ($districts as $key => $value)
                                                    <option value="{{ $value->id }}"
                                                        @if ($profile->district_id == $value->id) selected @endif>
                                                        {{ $value->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        <div class="form-group">
                                            <label class="form-label" for="area">Area<span>*</span></label>
                                            <select class="form-control select2 area" name="area" id="area" required>
                                                <option value="">Select..</option>
                                                @foreach ($areas as $key => $area)
                                                    <option value="{{ $area->id }}"
                                                        @if ($profile->area_id == $area->id) selected @endif>
                                                        {{ $area->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-check form-switch">
                                          <input class="form-check-input" type="checkbox" role="switch" value="1" name="twofa" id="twofa" @if($profile->twofa == 1) checked @endif>
                                          <label class="form-check-label" for="twofa">2 Factor Enable</label>
                                        </div>
                                    </div>
                                    <!-- col end -->
                          ...
                          <!-- tab item end -->
                           <div class="tab-pane fade" id="bank-tab-pane" role="tabpanel">
                            <form action="{{ route('merchant.payment_method') }}" method="POST"
                                enctype="multipart/form-data" data-parsley-validate="">
                                @csrf
                                <div class="row">
                                    <input type="hidden" value="{{ $profile->id }}" name="hidden_id">

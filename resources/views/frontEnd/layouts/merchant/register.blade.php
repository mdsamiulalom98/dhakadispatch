...
@section('title', 'Marchant Register')
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-sm-12">
                    <div class="auth-inner">
                        ...
                        <form action="{{ route('merchant.store') }}" method="POST" data-parsley-validate="" autocomplete="off" class="row">
                            @csrf
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    <label for="shop_name" class="form-label">Business Name <span>*</span></label>
                                    <input type="text"
                                        class="form-control  {{ $errors->has('shop_name') ? 'is-invalid' : '' }} has-validation"
                                        value="{{ old('shop_name') }}" id="shop_name" placeholder="Enter Shop Name *"
                            ...
                            <!-- form group -->
                            <p class="quick_link">Already have a account? <a href="{{ route('merchant.login') }}">
                                    Login</a></p>
                        </form>
                    </div>
                </div>

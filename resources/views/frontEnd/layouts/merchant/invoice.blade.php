...
<section class="customer-invoice ">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <a href="{{route('merchant.parcel.payment')}}"><strong><i class="fa-solid fa-arrow-left"></i> Back</strong></a>
            </div>
            <div class="col-sm-6">
                        ...
                        <tr>
                            ...
                            <td  style="width:60%;float: left;">
                                ...
                                <div class="invoice_to" style="padding-top: 0px;">
                                    ...
                                    <p style="font-size:16px;line-height:1.8;color:#222;text-align: right;font-weight:normal">{{$payment->merchant?$payment->merchant->name:''}}</p>
                                    <p style="font-size:16px;line-height:1.8;color:#222;text-align: right;font-weight:normal">{{$payment->merchant?$payment->merchant->phone:''}}</p>
                                    <p style="font-size:16px;line-height:1.8;color:#222;text-align: right;font-weight:normal">{{$payment->merchant?$payment->merchant->address:''}}</p>
                        ...
                        <table class="table" style="width: 300px; float: right;    margin-bottom: 30px;">
                            <tbody style="background:#3F9669">
                                <tr style="color:#fff">
                                    ...
                                    <td style="font-weight: 600;font-size:15px">৳{{$payment->cod}}</td>
                                </tr>
                                <tr style="color:#fff">
                                    <td style="font-weight: 600;font-size:15px">Delivery Charge(-)</td>
                                    <td style="font-weight: 600;font-size:15px">৳{{$payment->delivery_charge}}</td>
                                </tr>
                                <tr style="color:#fff">
                                    <td style="font-weight: 600;font-size:15px">Cod Charge(-)</td>
                                    <td style="font-weight: 600;font-size:15px">৳{{$payment->cod_charge}}</td>
                                </tr>
                                <tr style="color:#fff">

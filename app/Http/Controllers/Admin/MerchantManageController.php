...
class MerchantManageController extends Controller
{
    ...
    public function create(){
        ...
        return view('backEnd.merchant.create',compact('districts'));
    }
    ...
    public function index(Request $request){
        ...
        return view('backEnd.merchant.index',compact('show_data'));
    }
    public function payment($slug,Request $request){
        ...
        return view('backEnd.merchant.payment',compact('payments'));
    }
    public function invoice($id){
        $payment = Payment::where(['id'=>$id,'user_type'=>'merchant'])->first();
        return view('backEnd.merchant.invoice',compact('payment'));
    }
    ...
    public function edit($id){
        ...
        return view('backEnd.merchant.edit',compact('edit_data','districts','areas'));
    }
    ...
    public function profile(Request $request){
        ...
        return view('backEnd.merchant.profile',compact('profile','total_cod','total_payment','total_charge','total_paid','total_hold','parcels','payments'));
    }
    public function menual_payment(Request $request){
        ...
        return view('backEnd.merchant.menual_payment',compact('parcels','merchant','merchantpay'));
    }
